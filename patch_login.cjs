    ...
    <div className="flex min-h-[100dvh] font-sans bg-white selection:bg-[#0B1B33]/10 selection:text-[#0B1B33]">
      ...
      <div className="hidden md:flex md:w-[45%] lg:w-[55%] relative bg-[#0B1B33] overflow-hidden flex-col justify-between">
        ...
        <div className="absolute inset-0 pointer-events-none z-0 overflow-hidden">
           <img src="/icons/luxo.png" alt="Engenharia e Construção" className="absolute inset-0 w-full h-full object-cover object-center opacity-[0.35] mix-blend-luminosity" />
           {/* Deep Navy Gradient Overlays */}
           <div className="absolute inset-0 bg-gradient-to-br from-[#0B1B33]/95 via-[#0B1B33]/80 to-[#0B1B33]/95"></div>
           <div className="absolute inset-0 bg-gradient-to-t from-[#0B1B33] via-transparent to-transparent opacity-80"></div>
           ...
           <div className="absolute top-[-20%] right-[10%] w-[2px] h-[150%] bg-gradient-to-b from-transparent via-[#C6922E]/20 to-transparent transform rotate-12"></div>
           <div className="absolute top-[20%] left-0 w-[150%] h-[1px] bg-white/[0.03] transform -rotate-12"></div>
        </div>
        
        {/* Top Content: Branding */}
        <div className="relative z-10 p-8 lg:p-14 xl:p-20 flex flex-col items-start mt-4 animate-in fade-in slide-in-from-left-8 duration-1000 ease-out">
          <img src="/icons/icone2.png" alt="PCEG Icon" className="w-24 h-24 lg:w-28 lg:h-28 xl:w-36 xl:h-36 object-contain drop-shadow-2xl mb-8" />
          
          <h1 className="text-white text-5xl lg:text-6xl xl:text-7xl font-extrabold tracking-tight mb-2 leading-none">
            PCEG
          </h1>
          <h2 className="text-[#C6922E] text-xs lg:text-sm xl:text-base uppercase tracking-[0.25em] font-bold mb-8">
            Pedro Castro<br/>Engenharia e Gestão
          </h2>

          <div className="w-16 h-[2px] bg-[#C6922E] mb-6"></div>
          <p className="text-white/90 text-base lg:text-lg xl:text-xl font-light italic leading-relaxed max-w-sm">
            "Gestão inteligente.<br />Obras eficientes."
          </p>
        </div>

        {/* Bottom Content: Modules */}
        <div className="relative z-10 px-8 lg:px-14 xl:px-20 pb-12 flex flex-wrap gap-6 lg:gap-12 mt-auto animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-300 ease-out fill-mode-both">
      ...
      <div className="flex-1 flex flex-col relative justify-center bg-white md:bg-[#F8FAFC]">
        
        <div className="w-full max-w-[420px] mx-auto p-6 sm:p-10 z-10 flex flex-col min-h-full justify-center animate-in fade-in zoom-in-[0.98] duration-700 ease-out">
          
          {/* Mobile Branding (Hidden on Tablet/Desktop) */}
          <div className="md:hidden flex flex-col items-center text-center mt-2 mb-8">
            <img src="/icons/icone2.png" alt="PCEG Icon" className="w-24 h-24 sm:w-28 sm:h-28 object-contain mb-4 drop-shadow-sm" />
            <h1 className="text-3xl sm:text-4xl font-extrabold text-[#0B1B33] tracking-tight mb-1">
              PCEG
            </h1>
            <h2 className="text-[#C6922E] text-[10px] sm:text-[11px] uppercase tracking-[0.2em] font-bold mb-5">
              Pedro Castro Engenharia e Gestão
            </h2>
            <div className="w-10 h-[2px] bg-[#C6922E] rounded-full"></div>
          </div>
          ...
          <div className="flex-1 flex flex-col justify-center">
            ...
            <div className="mb-8 text-center md:text-left">
              ...
              <p className="text-gray-500 font-medium text-[14px] sm:text-[15px]">
