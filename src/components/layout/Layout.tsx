...
export function AdminLayout() {
  ...
  if (
    ...
    !location.pathname.startsWith("/admin/relatorios") &&
  ...
  if (unreadCentralComms.length > 0) {
    return (
      <CentralCommunicationViewer
        communications={unreadCentralComms}
        onComplete={() => setUnreadCentralComms([])}
      />
    );
  }
  ...
  const adminMenuGroups = [
    ...
    },
    {
      name: "Pessoas",
      icon: Users,
      items: [{ name: "Funcionários", path: "/admin/funcionarios" }],
    },
    {
      ...
      items: [
        {
          ...
          path: "/admin/central-comunicacoes",
        },
  ...
  const menuGroups =
    usuario.perfil === "CONSULTA" ? consultaMenuGroups : adminMenuGroups;
        ...
        <nav className="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
          {menuGroups.map((group, index) => {
            ...
            const isFirstInSection =
              group.section &&
              (index === 0 || menuGroups[index - 1].section !== group.section);
                  ...
                  >
                    <Icon
                      className={cn(
                        ...
                        isActive
                          ? "text-[#C6922E]"
                          : "text-gray-400 group-hover:text-[#0B1B33]",
                      )}
                    />
                    {group.name}
                  </Link>
                  ...
                  <button
                    ...
                    className={cn(
                      ...
                      hasActiveChild && !isExpanded
                        ? "bg-[#0B1B33]/5 text-[#0B1B33] font-bold"
                        : "text-gray-600 hover:bg-gray-50 hover:text-[#0B1B33]",
                    )}
                  >
        ...
        <div className="p-4 border-t border-gray-100 bg-slate-50 mt-auto">
          <div className="flex items-center px-3 py-2 text-sm font-bold text-[#0B1B33]">
            <div className="flex-1 min-w-0">
              ...
              <div className="text-[11px] text-gray-500 font-medium uppercase tracking-wider mt-0.5">
                Administrador
              </div>
            </div>
          </div>
...
export function OperadorLayout() {
  ...
  useEffect(() => {
    ...
    if (!checkingPresenca) {
      if (
        !presencaHojeConcluida &&
        location.pathname !== "/operador/presenca"
      ) {
      ...
      <nav className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 z-50 px-2 pb-safe shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)]">
        <div className="max-w-md md:max-w-5xl mx-auto flex h-16">
          ...
          <Link
            ...
            className={cn(
              "flex-1 flex flex-col items-center justify-center text-xs font-medium transition-colors",
              location.pathname === "/operador/ferramentas"
                ? "text-blue-600"
                : "text-gray-500 hover:text-gray-900",
            )}
          >
          ...
          <Link
            ...
            className={cn(
              "flex-1 flex flex-col items-center justify-center text-xs font-medium transition-colors",
              location.pathname === "/operador/controle-materiais"
                ? "text-blue-600"
                : "text-gray-500 hover:text-gray-900",
            )}
          >
